...
- Narrative scenes with emotional texture (encounters, healings, calls, meals, parables)
...
If the criteria references a liturgical occasion (e.g., Maundy Thursday, Good Friday, Advent, Lent), pick a passage traditionally associated with that moment. For Maundy Thursday, for example: consider John 13 (foot washing), Luke 22:14–30 (last supper), or John 17 (high priestly prayer).
...
> "Where do you feel in your body as you hear these words?"
...
- **Passage citation** - link to the passage in the chosen translation on bible.com, Bible reference, translation, and title of the passage
- **Background Youtube video** — link to nature video with no words, maybe related to current season or motifs in the passage
- **Somatic grounding exercise** — 2–3 minutes; feet on floor, breath, body scan, wheel of awareness, tension exercise or stretch, releasing the noise of the day into God's hands. Gentle and non-clinical in tone.
...
- **Sharing invitation** — gentle invitation to optionally share if they wish; name one specific person to go first (use a placeholder like [Name] if no names are known)
...
Include approximate timing markers in the guide (e.g., `*(~5 min)*`).
